...
<?php		
		...
		echo "								<td> <input type=\"text\" name=\"insert_nom_article\" required=required pattern=\"([\'-A-zÀ-ž\s]){3,}\"></td>\n";
...
function modifierArticle($dataArticle) {
	echo "			<h4>Modifier un article</h4>\n";
	echo "			<div class=\"custyle\">\n";
...
<?php		
		...
		foreach($dataArticle as $tuple) {	
			if ($tuple['id_auteur'] == $_SESSION['id']) {
				...
				echo "								</td>\n";						
				echo " 								<td>\n";
				echo "									<button class=\"btn btn-default btn-circle\" type=\"submit\"><img width=\"25\" height=\"25\" src=\"images/modif.png\" alt=\"modifier\"/></button>\n";
				echo "								</td>\n";				
				echo "							</tr>\n";
				echo "						</form>\n";
			}
...
function tabSupprimerArticle($dataArticle) {
	echo "			<h4>Supprimer un article</h4>\n";
	echo "			<div class=\"custyle\">\n";
									
	// On vérifie si l'utilisateur a cliqué sur un bouton pour supprimer un article
	...
	if (count($dataArticle) >= 1) {	
		...
		echo "			<p>Vous ne possédez aucun article</p>\n";
	}
	...
	foreach($dataArticle as $tuple) {	
		if ($tuple['id_auteur'] == $_SESSION['id']) {
			...
			echo "						</td>\n";
			echo "						<td>\n"; 
			echo "							<a href=\"lepetitscientifique.php?supprimerArticle&delete_id_article=".$tuple['id_article']."&delete_repertoire=".$tuple['repertoire']."\"><img width=\"25\" height=\"25\" src=\"images/supp.png\" alt=\"supprimer\"/></a>\n";
			echo "						</td>\n";	
			echo "					</tr>\n";
		}
	}
