...
function menu($dataCateg, $dataSousCateg, $dataArticle) {
	...
	if (isset($_SESSION['mail'])) {
		...
		echo "						<a href=\"deconnexion.php\"><img src=\"images/dec.png\" width=\"25\" height=\"25\" alt=\"deconnexion\"/></a>\n";
	}
	...
	foreach($dataCateg as $nomCateg) {
		...
		echo " 					</li>\n";
		echo "					<li><ul class=\"sub-menu collapse\" id=\"categ".$cpt."\">\n";
			...
			//	echo "						</li>\n";
				...
				$cpt2 = $cpt2 + 1;
					if ($nomSousCateg['id_souscateg'] == $nomArticle['id_souscateg']) {	
						...
						// Article accessible grâce à une redirection vers celle ci en cliquant
	...
	if (isset($_SESSION['mail']) && $_SESSION['admin'] == 1) {		
		...
		echo " 						<li>\n";
		echo "							<a class=\"block\" href=\"lepetitscientifique?ajouterSousCateg\">Ajouter une sous-categorie</a>\n";
		echo "						</li>\n";
		echo " 						<li>\n";
		...
		echo "							</li>\n";
		echo " 							<li>\n";
		echo "								<a class=\"block\" href=\"lepetitscientifique?modifierArticle\">Modifier un article</a>\n";
		echo "							</li>\n";
		echo " 							<li>\n";
		echo "								<a class=\"block\" href=\"lepetitscientifique?supprimerArticle\">Supprimer un article</a>\n";
		echo "							</li>\n";
		echo "						</ul>\n";
		echo "					</li>\n";
	} else {
